				...
				<div className="flex h-20 items-center justify-between">
					<div className="flex items-center">
						<Link href="/" className="flex items-center space-x-3">
							...
							<span className="font-bold text-xl hidden md:inline-block text-black">
								UpscaleTek
							</span>
						</Link>
					</div>
						...
						{navItems.map((item) => (
							<Link
								...
								className={cn(
									...
									pathname === item.path ? "text-primary" : "text-black/80",
								)}
							>
								{item.name}
				...
				<div className="md:hidden bg-black/95 backdrop-blur-lg border-b border-white/10">
					<div className="container mx-auto px-4 py-6">
						<nav className="flex flex-col space-y-4">
							...
							<Button className="rounded-full mt-4 bg-gradient-to-r from-primary to-purple-600">
								Get Started
							</Button>
						</nav>
					</div>
